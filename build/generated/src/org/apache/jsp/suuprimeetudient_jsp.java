...
public final class suuprimeetudient_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<h2 class=\"form-title\">SUPPRIMER ÉTUDIANT</h2>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t<form method=\"post\" action=\"supprimer\" class=\"register-form\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"Numero de Chambre\" id=\"email\" placeholder=\"Numero de Chambre\" />\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tclass=\"form-submit\" value=\"SUPPRIMER\" />\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"signup-image\">\n");
      out.write("\t\t\t\t\t\t<figure>\n");
      out.write("\t\t\t\t\t\t\t<img src=\"https://st.depositphotos.com/1011643/4248/i/450/depositphotos_42489785-stock-photo-cute-african-university-law-school.jpg\" alt=\"sing up image\">\n");
      out.write("\t\t\t\t\t\t</figure>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
