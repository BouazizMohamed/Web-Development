...
public final class SupprimerRec_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<h2 class=\"form-title\">SUPPRIMER RECLAMATION</h2>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t<form method=\"post\" action=\"SupprimerRec\" class=\"register-form\"\n");
      out.write("\t\t\t\t\t\t\tid=\"register-form\">\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("                                                    <div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"NUMERO_CHAMBRE\"><i class=\"zmdi zmdi-email\"></i></label> <input\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"NUMERO_CHAMBRE\" id=\"NUMERO_CHAMBRE\" placeholder=\"Numero de Chambre\" />\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"TYPE\"><i\n");
      out.write("\t\t\t\t\t\t\t\t\tclass=\"zmdi zmdi-account material-icons-name\"></i></label> <input\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"TYPE\" id=\"TYPE\" placeholder=\"TYPE\" />\n");
      out.write("                                                                        \n");
      out.write("                                                                        \n");
      out.write("                                                                        \n");
      out.write("                                                                        \n");
      ...
      out.write("\t\t\t\t\t\t<figure>\n");
      out.write("\t\t\t\t\t\t\t<img src=\"http://www.clipartbest.com/cliparts/BdT/r6p/BdTr6pai9.png\" alt=\"sing up image\">\n");
      out.write("\t\t\t\t\t\t</figure>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
