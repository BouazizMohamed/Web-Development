...
public final class espaceadmin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<figure>\n");
      out.write("\t\t\t\t\t\t\t<img src=\"https://www.picpedia.org/chalkboard/images/administration.jpg\" alt=\"sing up image\">\n");
      out.write("\t\t\t\t\t\t</figure>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\n");
      out.write("\t\t\t\t\t<div class=\"signin-form\">\n");
      out.write("\t\t\t\t\t\t<h2 class=\"form-title\">ESPACE ADMINISTRATION</h2>\n");
      out.write("\t\t\t\t\t\t<form method=\"post\" action=\"LoginStaff\" class=\"register-form\"\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"Adresse Email\" id=\"username\"\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"Adresse Email\" />\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"password\"><i class=\"zmdi zmdi-lock\"></i></label> <input\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"password\" name=\"Mot de passel\" id=\"password\"\n");
